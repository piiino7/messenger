                        ...
                        <div class="message-body">
                            <div class="message-content">
                                <div class="message-text" v-if="message.type=='text'">
                                   <blockquote class="blockquote overflow-hidden" v-if="message.forward_id">
                                        <h6 class="text-reset text-truncate">{{ message.children.user.name }}</h6>
                                        <p class="small text-truncate">{{ message.children.body }}</p>
                                    </blockquote>
                                    <p>{{message.body}}</p>
                                </div>
                                ...
                                <div class="message-action">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center" href="#" v-if="message.user_id == $root.userId">
                                                    <span class="me-auto" @click.prevent="$root.updateMessage(message)">Edit</span>
                                                    <div class="icon">
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <span class="me-auto" @click.prevent="$root.forwardMessage(message)">Reply</span>
                                                    <div class="icon">
                                            ...
                                            <li>
                                                <hr class="dropdown-divider" v-if="message.user_id == $root.userId">
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center text-danger" href="#" v-if="message.user_id == $root.userId">
                                                    <span class="me-auto" @click.prevent="$root.deleteMessage(message, 'all')">Delete</span>
                                                    <div class="icon">
