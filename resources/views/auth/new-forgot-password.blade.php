<html lang="en" m_init="2233643202311171224"><!-- Head --><head>
    <meta charset="UTF-8">
    ...
    <style type="text/css">svg:not(:root).svg-inline--fa {
        ...
        .fad.fa-inverse {
            color: #fff;
        }</style><link rel="shortcut icon" href="./assets/img/favicon/favicon.ico" type="image/x-icon">
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="col-12 col-md-5 col-lg-4">
            <div class="card card-shadow border-0">
                <div class="card-body">
                    <div class="row g-6">
                        ...
                        <div class="col-12">
                            <button class="btn btn-block btn-lg btn-primary w-100" type="submit">{{ __('Email Password Reset Link') }}</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mt-8">
                <p>Already have an account? <a href="{{ route('login') }}">{{ __('Log in') }}</a></p>
            </div>
        </div>
    </div> <!-- / .row -->
    </form>
