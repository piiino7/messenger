...
<!-- Head -->
<head>
    @vite(['resources/js/app.js', 'resources/js/messages.js'])
    <meta charset="UTF-8">
...
<!--                                <div class="card-body">
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="accordion-profile-body-1" class="accordion-collapse collapse" aria-labelledby="accordion-profile-1" data-parent="#accordion-profile">
                                                    <div class="accordion-body">
                                                        ...
                                                        <button class="btn btn-block btn-lg btn-primary w-100">{{ __('Save') }}</button>
                                                ...
                                                <div id="accordion-security-body-1" class="accordion-collapse collapse" aria-labelledby="accordion-security-1" data-parent="#accordion-security">
                                                    <div class="accordion-body">
                                                            ...
                                                            <div class="form-floating mb-6">
                                                                ...
                                                                <x-input-label for="password_confirmation">Verify Password</x-input-label>
                                                            </div>
                            ...
                            <div class="mt-8">
                                <div class="d-flex align-items-center my-4 px-6">
                                    <small class="text-muted me-auto">Delete account</small>
                                </div>
                                ...
                                <div class="card border-0">
                                    <div class="card-body py-2">
                                        <!-- Accordion -->
                                        <div class="accordion accordion-flush" id="accordion-delete">
                                            <div class="accordion-item">
                                                <div class="accordion-header" id="accordion-delete-1">
                                                    <a href="#" class="accordion-button text-reset collapsed" data-bs-toggle="collapse" data-bs-target="#accordion-delete-body-1" aria-expanded="false" aria-controls="accordion-delete-body-1">
                                                        <div>
                                                            <h5>Delete account</h5>
                                                        </div>
                                                    </a>
                                                </div>
                                                <div id="accordion-delete-body-1" class="accordion-collapse collapse" aria-labelledby="accordion-delete-1" data-parent="#accordion-delete">
                                                    <div class="accordion-body">
                                                        <h2>
                                                        ...
                                                        <button class="btn btn-block btn-lg btn-danger w-100">{{ __('Delete Account') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    var pusher = new Pusher('789062c52b1259cbcb92', {
        cluster: 'eu',
...
<script>
    import Messenger from "../js/components/messages/Messenger.vue";
    import ProfilePicture from "../js/components/messages/ProfilePicture.vue";
    export default {
        components: {ProfilePicture, Messenger}
    }
</script>
